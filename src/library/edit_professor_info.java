 ...
 */
public class edit_professor_info extends javax.swing.JFrame {

    /**
     * Creates new form edit_professor_info
     */
    public edit_professor_info() {
        initComponents();
    }
    public edit_professor_info(professor proff) {
        initComponents();
        jTextField7.setText(Integer.toString(proff.ID));
        jTextField1.setText(proff.getFname());
        jTextField2.setText(proff.getLname());
        jTextField3.setText(proff.getAddress());
        int phone=proff.Phone_number;
        jTextField4.setText(Integer.toString(phone));
         jTextField5.setText(proff.Faculty);
         jTextField6.setText(proff.Degree);
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Edit any thing in the professor information");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(jTextField1.getText().isEmpty()||jTextField2.getText().isEmpty()||jTextField3.getText().isEmpty()||jTextField4.getText().isEmpty()||jTextField5.getText().isEmpty()
            ...
            String degree=jTextField6.getText().trim();
            int id=Integer.parseInt(jTextField7.getText().trim());
            employee empl=new employee();
            empl.update_prof(id, Lname, Lname, adress, phone, faculty, degree);}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(edit_professor_info.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new edit_professor_info().setVisible(true);
            }
        });
    }
