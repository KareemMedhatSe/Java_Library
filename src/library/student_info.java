...
public class student_info extends javax.swing.JFrame {
    ...
    public student_info() {
     ...
     public student_info(student st) {
        initComponents();
        jTextField1.setText(st.getFname()+" "+st.getLname());
        jTextField2.setText(st.getAddress());
        int phone=st.Phone_number;
        jTextField3.setText(Integer.toString(phone));
         jTextField4.setText(st.Faculty);
         jTextField5.setText(Integer.toString(st.Year));
    }
